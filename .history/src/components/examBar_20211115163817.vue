...
<section class="exam-bar">
    <div class="exam-choice" @click="selectPop=!selectPop"><i class="iconGFY icon-file"></i><span class="badge">{{total}}</span></div>
    ...
    <van-overlay class-name="exam-bar-overlay" :show="selectPop" @click="selectPop = false" />
    ...
    <van-popup v-model="addExam" position="bottom">
        <div class="add-exam-wrap">
            ...
            <van-cell v-if="(canAddCourse && !isRevert)||(qesTypeName)||(knowledgePoint)||special" class="add-exam-wrap__cell">
                <!-- <van-cell  class="add-exam-wrap__cell"> -->
                <div slot="title">
...
export default {
    ...
    methods: {
        viewResCenter() {
            ...
            if (this.isRevert) {
                ...
                if (this.$route.path === '/examDetail') {
                    ...
                    console.log(this.$route.query.isQuestionType, 'this.$route.query')
                    //   alert(this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.tchCourseId)
                    //  alert(this.$route.query.tchCourseId)
                    //111111
                    try {
                        MobclickAgent.onEvent('clickQuestionSelectOther')
                    } catch (e) {
                        console.log(e)
                    }
                    this.$router.push(`/resCentreWrap?from=questionList&isQuestionType=${this.$route.query.isQuestionType}`)
                ...
                if (res.flag) {
                    ...
                    if (this.$route.path === '/errorQuestionDetail' || this.$route.path === '/errorBook') {
                        ...
                        this.courseList.push({
                            ...
                            classGrade: '',
                            radio: this.courseList.some(v => v.radio !== '') ? '' : 0
                        })
        ...
        addTestPaper() {
            ...
            if (this.$route.path === '/questionList') {
                if (this.$route.query.isQuestionType) {
                    //专项练习--题型专项--生成试卷
                    try {
                        MobclickAgent.onEvent('specialExerTypeAddExam')
                    } catch (e) {
                        console.log(e)
                    }
                    ...
                    //专项练习--知识点专项--生成试卷
                    try {
                        MobclickAgent.onEvent('specialKngAddExam')
                    } catch (e) {
                        console.log(e)
                    }
                }
                ...
                if (this.$route.query.isRes) {
                    if (this.$route.query.isPri) {
                        try {
                            MobclickAgent.onEvent('resCenterPriQuestionAddExam')
                        } catch (e) {
                            console.log(e)
                        }
                    } else {
                        try {
                            MobclickAgent.onEvent('resCenterPlatQustionAddExam')
                        } catch (e) {
                            console.log(e)
                        }
                    }
                    ...
                    try {
                        MobclickAgent.onEvent('questionAddExamSubmit')
                    } catch (e) {
                        console.log(e)
                    }
                }
                ...
                try {
                    MobclickAgent.onEvent('errorbookAddExamSubmit')
                } catch (e) {
                    console.log(e)
                }
            }
        ...
        addTeachCourseRes(resourceId, name, paperInfo) {
            // alert(this.$route.query.tchCourseId)
            // console.log(this.courseList,'1111111111111111111')
            // console.log(this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.tchCourseId )
            // console.log(this.courseList,'this.courseList1111111111')
            this.form.btnLoading = true
            let obj = {
                "interUser": "runLfb",
                "interPwd": "25d55ad283aa400af464c76d713c07ad",
                ...
                "belongSchoolId": this.$store.getters.schoolId,
                "operateRoleType": "A02",
                //   "tchCourseId": this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.tchCourseId ,
                // "sysCourseId": this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.sysCourseId ,
                // "relationSeqId": this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.relationCourseId ,
                "tchCourseId": ((this.canAddCourse && !this.isRevert) || this.qesTypeName || this.knowledgePoint || this.special) ? this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.tchCourseId : this.$route.query.tchCourseId,
                "sysCourseId": ((this.canAddCourse && !this.isRevert) || this.qesTypeName || this.knowledgePoint || this.special) ? this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.sysCourseId : this.$route.query.sysCourseId,
                "relationSeqId": ((this.canAddCourse && !this.isRevert) || this.qesTypeName || this.knowledgePoint || this.special) ? this.courseList[this.listIndex].arr[this.radioIndex].tchCourseInfo.relationCourseId : this.$route.query.relationCourseId,
                "resourceType": "R02",
                resourceId,
                "statusCd": "S04"
            }
