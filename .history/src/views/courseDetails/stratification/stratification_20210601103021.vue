...
export default {
    ...
    watch: {
        ...
        'layerUserStatus_s': {
            handler(newval, olval) {
                ...
                console.log(localStorage.getItem('layerUserStatus'), newval,"newval------------------------------------------")
    ...
    created() {
        // this.socketApi.getSock(this.getLayerUserStatus);
    ...
    async mounted() {
        ...
        // if(this.$store.getters.getLayerUserStatus.initializationState){
        //     this.btnStatus = true
        // }else{
        //     this.btnStatus = false
        // }
        // this.getLayerTaskInfoDetail1(this.taskId)
    }
}
</script>
