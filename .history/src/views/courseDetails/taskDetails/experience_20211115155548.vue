...
<div class="experience">
    <van-list v-model="listLoading" :finished="finished" :finished-text="appraiseList.length > 0 ? '没有更多了' : ''" @load="onLoad" :offset="80" :error.sync="error" error-text="请求失败，点击重新加载">
        <!--        学生心得-->
        <stu-exp @focus="showFooter = false" @blur="showFooter = true" @score="handleScore" @delReply="delReply" @submit="submit" @addPraiseClick="addPraiseClick" @delPraiseClick="delPraiseClick" @topClick="topClick" @untopAppraise="untopAppraise" @essenceClick="essenceClick" @unessAppraise="unessAppraise" @delAppraise='delAppraise' @sendClick="sendClick" :classId="$store.getters.getUserInfo.classId" :currentPage="currentPage" :total="total" :finished="finished" :list="appraiseList" :disable="isDisabled" :isfEducation="isfEducation" ref="stuExps">
        </stu-exp>
    </van-list>
