...
<template>
  <div class="microlecture">
    ...
    <div class="ware-detail" v-if="$store.getters.getBaseData.taskType !== 'T06'">
      <!-- <van-button class="openWps" v-if="type != 'mp3' && wareDetail.courseware.srcUrl" @click="openWps" type="primary">本地打开</van-button> -->
      ...
      <img
        class="audio"
        v-else-if="type === 'mp3' && wareDetail.courseware.srcUrl"
        src="https://pubquanlang.oss-cn-shenzhen.aliyuncs.com/picture/201910/icon-mp3.png"
        alt=""
      ...
      <!-- <iframe id="iframe" v-else-if="(type === 'office' || type === 'pdf') && wareDetail.courseware.srcUrl && !loadWareFlag" :src="wareDetail.courseware.srcUrl"></iframe> -->
    </div>
  </div>
</template>
