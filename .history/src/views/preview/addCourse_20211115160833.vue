...
import {
    getTextBookCourseByParam,
    getShareCourseDetailV2,
    createTeachCourse,
    getClassTeacherCourseDeploy,
    modifyTeachCourse
} from '@/api/index'
    ...
    methods: {
        ...
        createCourse() {
            ...
            if (this.$route.query.from === 'myCourse') {
                try {
                    MobclickAgent.onEvent('myCourseAddCourseSubmit')
                } catch (e) {
                    console.log(e)
                }
            } else if (this.isfEducation) {
                try {
                    MobclickAgent.onEvent('familyEduAddCourseSubmit')
                } catch (e) {
                    console.log(e)
                }
            } else {
                try {
                    MobclickAgent.onEvent('addCourse')
                } catch (e) {
                    console.log(e)
                }
            }
        ...
        handleEditClass() {
            ...
            try {
                MobclickAgent.onEvent(this.isfEducation ? 'familyEditCourseSubmit' : 'editMyCourseSubmit')
            } catch (e) {
                console.log(e)
            }
