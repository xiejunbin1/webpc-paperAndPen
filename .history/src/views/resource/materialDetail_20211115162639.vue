<template>
  <section class="board-detail">
    <!-- <van-nav-bar :title="info.coursewareName" @click-left="goBack" left-arrow> </van-nav-bar> -->
    <h2>
      {{ info.coursewareName }}
    </h2>
    <div class="board-detail__body">
      ...
      <!-- <video controls="controls" controlsList="download" src="https://pubquanlang.oss-cn-shenzhen.aliyuncs.com/video/202002/20190407%E8%B5%B0%E8%BF%9B%E5%85%A8%E6%9C%97.mp4"></video> -->

      <!-- <list-item class="mgt10" :itemTitle="info.coursewareName">
        <div slot="desc">
          <div class="desc-top">发布者:{{ info.belongAccountName }}</div>
