...
let getParentName = (accountNo, classId) => {
  ...
  if (localStorage.getItem('parentClassList')) {
    ...
    console.log(parentList,"parentListparentList-----")
...
export { getFontSize, toHump, getTaskTypeName, ellipsis, mutualType, formatSeconds, formathms, generateTimeReqestNumber, formatTime, randomString, getSubjectName, getStudentName, getParentName, getGradeName, getTermName, getPeriodName, dealType, numToWord, getYearSection }
