...
// 批注提交
export const updateAppraise = (params) => {
  return axios.post('public/updateAppraise',qs.stringify(params))
}
...
// 删除
export const delAppraise = (params) => {
  return axios.post('public/delAppraise', qs.stringify(params))
}

// 获取纸笔痕迹
export const getPaperPen = (params) => {
  return axios.post('public/getPaperPen', qs.stringify(params))
}
